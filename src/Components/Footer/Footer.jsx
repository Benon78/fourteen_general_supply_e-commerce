    ...
    <div className='footer'>
        <div className="footer-content">
            <div className="footer-about">
                <h3>About Us</h3>
                <p>Fourteen General Supply is a shop for all your computer needs
            ...
            perfect device to fit your needs.</p>
            </div>
            <div className="footer-links">
                ...
                <ul>
                    ...
                    <li><Link>Shiping Policy</Link></li>
        ...
        <div className="footer-copyright">
            <div className="copyright">
                Copyright <span>&copy;</span> {getFullYear} Fourteen General
